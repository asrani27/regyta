...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Input Bidang</h6>
        </div>
        <div class="card-body">
            <form method="post" action="/superadmin/bidang/create">
                @csrf
                <div class="form-group">
                    <div class="mb-1 small">Nama Bidang</div>
                    <input type="text" class="form-control" required name="nama_bidang">
                </div>
                <div class="form-group">
