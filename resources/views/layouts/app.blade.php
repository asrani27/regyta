...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Regyta</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Page level plugins -->
    <script src="/theme/docs/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/theme/docs/js/demo/chart-area-demo.js"></script>
    <script src="/theme/docs/js/demo/chart-pie-demo.js"></script>
...
<body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Rifai</a>
